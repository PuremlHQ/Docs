...
If all goes well, You should have a PureML local instance setup and running with your backend hosted at http://localhost:8080/api.
...
<Warning>
  Currently, frontend is not usable for self-hosted version. Support for that
  will be added soon
</Warning>
