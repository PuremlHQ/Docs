...
```python
pureml.log(metrics={'accuracy': 0.9, 'f1': 0.8}, params={'random_state': 42, 'channels': 3}, label='sales forecast:dev')
```
...
```python
pureml.log(metrics={'accuracy': 0.9, 'f1': 0.8}, params={'random_state': 42, 'channels': 3}, label='sales forecast:dev:v3')
```
