...
PureML supports dynamic policy application to a model from the Dashboard.  

---
title: Applying Policy Pack in PureML
---

## Applying Policy Pack in PureML

After logging into PureML:
