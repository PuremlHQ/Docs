...
@dataset("<dataset_branch:dataset_version>")
...
pureml.eval(task_type='classification', label_dataset='<dataset_name:dataset_branch:dataset_version>', label_model='<model_name:model_branch:model_version>')
```
